                        ...
                        <div key={w.id} style={S.card}>
                            ...
                            <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:12 }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontSize:11, color:"#888" }}>{w.phone} . {sum.totalJobs || 0} jobs</div>
                                </div>
                            </div>

                            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:6, marginBottom:10 }}>
                                {[["Sent",sent, "#185FA5"], ["Received",recv, "#3B6D11"],["Pending",(sum.pending ||0), (sum.pending||0)>0?"#854F0B":"#3B6D11"]].map(([l,v,c]) => (
